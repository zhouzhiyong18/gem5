...
#ifndef __L0Cache_TBE_HH__
#define __L0Cache_TBE_HH__
...
()
        ...
        m_TBEState = L0Cache_State_I; // default value of L0Cache_State
        // m_DataBlk has no default
        m_Dirty = false; // default for this field
        m_pendingAcks = 0; // default for this field
    }
    L0Cache_TBE(const L0Cache_TBE&other)
    {
        m_addr = other.m_addr;
    ...
    L0Cache_TBE(const Addr& local_addr, const L0Cache_State& local_TBEState, const DataBlock& local_DataBlk, const bool& local_Dirty, const int& local_pendingAcks)
    {
        m_addr = local_addr;
    ...
    void
    setTBEState(const L0Cache_State& local_TBEState)
    {
        m_TBEState = local_TBEState;
    }
...
inline std::ostream&
operator<<(std::ostream& out, const L0Cache_TBE& obj)
{
    obj.print(out);
    out << std::flush;
    return out;
